    ...
    <div class="adminCreationForm">
        ...
        <form action={{ route('admin.signup') }} method="POST">
            ...
            <div class="inputLabel">
                <input type="text" id="allInputs1" class="input-field" name="admin_name" onchange="changeee()">
            ...
            @endif
            <div class="inputLabel">
                <input type="text" id="allInputs2" class="input-field" name="admin_email" onchange="changeeee()">
            ...
            @endif
            <div class="inputLabel">
                <input type="password" id="allInputs3" class="input-field" name="admin_password" onchange="changee()">
            ...
            <div class="inputLabel">
                <input type="password" id="confirme1" class="input-field" name="admin_password_confirmation" onchange="confirme()">
